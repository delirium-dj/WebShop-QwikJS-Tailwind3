    ...
    <>
      ...
      */}
      <button
        ...
        class="relative inline-flex items-center p-2 text-gray-700 transition-colors hover:text-black"
      ...
      >
        ...
        */}
        <CartCountBadge
          ...
          class="absolute -right-1 -top-1 h-5 w-5 animate-pulse text-xs"
        />
      </button>
