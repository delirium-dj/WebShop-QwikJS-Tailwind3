  ...
  ({ mode, onError$ }) => {
    ...
    const handleSocialAuth$ = $(async (provider: string) => {
      ...
      try {
         ...
         */
        await auth.actions.signInWithProvider(
    ...
    return (
      ...
      */}
        <button
          ...
          class="flex w-full items-center justify-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
        >
          {/* 
